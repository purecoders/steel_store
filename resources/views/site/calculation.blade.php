                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card text-center bg-primary text-white mb-3 mt-5">
                        <div class="card-body">
                            ...
                            <form style="direction: rtl !important;">
                                <div class="form-group row ">
                                    <label for="postTitle3" class="col-sm-5 col-form-label">مقدار اول :</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" required id="postTitle3"
                                               placeholder="به کیلوگرم">
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label for="postTitle4" class="col-sm-5 col-form-label">مقدار دوم :</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" required id="postTitle4"
                                               placeholder="به کیلوگرم">
                                    </div>
                                </div>
                                <div class="row">
